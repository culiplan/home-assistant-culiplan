"""Application credentials platform for Culiplan.

The Culiplan backend is a public OAuth 2.1 client: no client_secret, PKCE
(S256) mandatory. HA's default LocalOAuth2Implementation does not send
...
async def async_get_auth_implementation(
    ...
    """Return PKCE-enabled auth implementation."""
...
async def async_get_authorization_server(hass: HomeAssistant) -> AuthorizationServer:
    """Return authorization server (fallback when no custom impl is used)."""
